...
<head>
    ...
    <style>
        ...
        .profile-dropdown, .cart-dropdown { position: relative; }
        .profile-btn, .cart-btn { position: relative; cursor: pointer; }
        ...
        .dropdown-menu.active, .cart-menu.active {
            display: block;
        ...
        .dropdown-header p { margin: 0; font-size: 12px; color: #6b7280; }
        .dropdown-header strong { font-size: 14px; color: #2c1810; }
        .dropdown-item {
            padding: 12px 20px;
            cursor: pointer;
            transition: all 0.3s;
        ...
        .dropdown-item:hover { background: #fff7ed; color: #d97706; }
        .dropdown-item.logout { color: #dc2626; border-top: 1px solid #e5e7eb; }
        ...
        .cart-menu { min-width: 350px; max-width: 400px; max-height: 500px; overflow-y: auto; }
        .cart-header { padding: 20px; border-bottom: 2px solid #e5e7eb; background: #f9fafb; }
        .cart-header h3 { margin: 0; font-size: 18px; color: #2c1810; }
        ...
        .checkout-btn {
            width: 100%;
            padding: 12px;
            background: linear-gradient(135deg, #d97706 0%, #b45f06 100%);
            color: white;
            border: none;
            border-radius: 10px;
            font-weight: 600;
        ...
        .empty-cart { padding: 40px; text-align: center; color: #6b7280; }
        ...
        @media (max-width: 768px) {
            .cart-menu { min-width: 300px; right: -50px; }
            .dropdown-menu { right: -20px; }
        }
        @media (max-width: 480px) {
            .cart-menu { min-width: 280px; max-width: 90vw; right: -80px; }
            .dropdown-menu { min-width: 180px; right: -30px; }
        }
