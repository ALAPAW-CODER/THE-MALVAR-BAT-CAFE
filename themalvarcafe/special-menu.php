...
$menuItems = [
    'frappe' => [
        ['name' => 'Dirty Matcha Latte', 'price' => 140, 'image' => 'images/dirty matcha latte.png', 'desc' => 'Matcha with espresso shot, topped with whipped cream'],
...
<body>
    ...
    <section class="special-menu-section">
        <div class="container">
            ...
            <!-- Frappe Section -->
            <h3 class="category-title">Frappe</h3>
            <div class="menu-grid">
                    ...
                    <div class="menu-details">
                        <div class="menu-header">
                            <div>
                                ...
                                <p class="menu-description"><?php echo htmlspecialchars($item['desc']); ?></p>
                            </div>
                        ...
                        <form method="POST" style="display: inline;">
                            ...
                            <button type="submit" name="add_to_cart" class="menu-cart-btn">🛒</button>
                        </form>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <!-- Iced Coffee Section -->
            <h3 class="category-title">Iced Coffee</h3>
            <div class="menu-grid">
            ...
            <!-- Meals Section -->
            <h3 class="category-title">Pasta & Rice Bowls</h3>
            <div class="menu-grid">
