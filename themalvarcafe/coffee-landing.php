...
<body>
    ...
    <section class="cafe-interior">
        <div class="interior-content">
            <div class="interior-text">
                <h2>Experience Our Cozy Atmosphere</h2>
                <p>Step into The Malvar Bat Cave Cafe and discover the perfect blend of comfort and productivity. Our thoughtfully designed space features cozy seating, ambient lighting, and a welcoming atmosphere that's ideal for studying, working, or simply relaxing with friends over a cup of our signature coffee.</p>
                <ul class="interior-features">
                    <li>✨ Comfortable seating areas</li>
                    <li>📚 Study-friendly environment</li>
                    <li>🎵 Relaxing ambiance</li>
                    <li>💡 Perfect lighting for work</li>
                </ul>
            </div>
            <div class="interior-image">
                <img src="images/interior2-malvar.jpg" alt="The Malvar Bat Cave Cafe Interior">
            </div>
        </div>
    </section>
    ...
    <section class="popular">
        ...
        <div class="products-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="images/vanilla latte.jpg" alt="Vanilla Latte">
                    <span class="rating">4.8 ⭐</span>
                </div>
                <div class="product-info">
                    <h3>Vanilla Latte</h3>
